...
class PitchConfigPayload(BaseModel):
    ...
    def normalize_legacy_default_pitch_size(self) -> "PitchConfigPayload":
        # Older UI builds sent 26 x 56 by default. The current pitch is 30 x 47.40 m,
        # so normalize the legacy hardcoded value to avoid corrupting homography/statistics.
