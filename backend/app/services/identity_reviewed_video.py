...
from app.services.video import VIDEO_TIMEBASE_SCHEMA_VERSION, resolve_match_video_path
...
def render_reviewed_video(
    ...
    *,
    ...
    manifest = {
        ...
        "media_duration_sec": round(encoded_frames / encoded_fps, 6),
