        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with (
                ...
                migrated = migrate_published_team_shape_only(
                    "published-match-1",
                    team_shape=shape,
                    team_shape_dependencies={
                        "pitch_config": {"width_m": 30.0, "length_m": 47.4},
                        "match_phase_config": {"phases": []},
                        "team_config": _package()["team_config"],
                    },
                    provenance={"schema_version": "team_shape_publication_refresh:v1", "reviewed_identity_digest": "reviewed-digest"},
                )
                ...
                self.assertEqual(package["team_shape_publication_refresh"]["reviewed_identity_digest"], "reviewed-digest")
...
def _ready_team_shape() -> dict:
    return {
        ...
        "generated_from": [{"artifact": "tracklets.json", "sha256": "sha256:source"}],
        "teams": [
            {
                "team_label": "A",
                "team_id": "team-corgi",
