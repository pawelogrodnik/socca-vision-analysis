...
def main() -> None:
    ...
    parser.add_argument("--policy-version", choices=(PREVIOUS_POLICY_VERSION, POLICY_VERSION, V3_POLICY_VERSION, V4_CONTINUITY_BRIDGE_POLICY_VERSION), default=POLICY_VERSION)
