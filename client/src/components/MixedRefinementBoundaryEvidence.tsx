...
export function MixedRefinementBoundaryEvidence({ matchId, refinement }: Props) {
  ...
  return <div className='mixed-refinement-boundaries' aria-label='Dokładne widoki graniczne'>
    <figure>
      <img src={artifactUrl(matchId, after.artifact)} alt='Lewy widok graniczny — podział następuje po tym widoku' />
    ...
    <figure>
      <img src={artifactUrl(matchId, before.artifact)} alt='Prawy widok graniczny — podział następuje przed tym widokiem' />
